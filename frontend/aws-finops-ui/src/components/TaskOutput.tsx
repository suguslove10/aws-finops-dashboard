    ...
    <div className="w-full max-w-[98vw] mx-auto">
      ...
      >
        <Card className="mb-6 border border-gray-200 dark:border-gray-700 shadow-lg transition-all duration-300 w-full px-1 sm:px-2">
          ...
          <AnimatePresence>
            {data?.status === 'running' && (
              <div className="flex items-center space-x-3 mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 rounded-lg border border-blue-200 dark:border-blue-800/30">
                <motion.div 
